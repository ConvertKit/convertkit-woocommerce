...
<p>
	...
	printf(
		...
		esc_html__( 'To configure the ConvertKit form, tag or sequence to subscribe customers to who use this %1$s, connect your ConvertKit account and %2$s.', 'woocommerce-convertkit' ),
