 ...
 * settings when the Subscribe Event = Order Completed, and an order is placed through WooCommerce
 * 
 * @since 	1.9.6
 */
class PurchaseDataOnOrderCompletedEventCest
{
	/**
	...
	public function testSendPurchaseDataWithSimpleProduct(AcceptanceTester $I)
	{
		...
		$result = $I->wooCommerceCreateProductAndCheckoutWithConfig(
			...
			'Order Completed', // Perform on WooCommerce "Order Completed" event (not used)
		...
		// Confirm that the purchase was now added to ConvertKit.
