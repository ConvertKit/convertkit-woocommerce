...
class PurchaseDataCest
{
	...
	public function testSendPurchaseDataWithSimpleProductCheckout(AcceptanceTester $I)
	{
		...
		$id = $I->apiCheckPurchaseExists($I, $result['order_id'], $result['email_address'], $result['product_id']);
		...
		$I->wooCommerceOrderMetaKeyAndValueExist($I, $result['order_id'], 'ckwc_purchase_data_id', $id, true);
	}
