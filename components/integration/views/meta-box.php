...
<p>
	<strong><?php esc_html_e( 'Important:' ); ?></strong>
	<?php esc_html_e( 'The ConvertKit integration for WooCommerce is currently disabled. Customers will not be subscribed when purchasing.' ); ?>
</p>
<?php } ?>

<?php if ( $options ) { ?>
<select class="widefat" id="ckwc_subscription" name="ckwc_subscription">
	<option <?php selected( '', $subscription ); ?> value=""><?php esc_html_e( 'Select a subscription option...' ); ?></option>
...
<?php } else { ?>
<p>
	<?php esc_html_e( 'Please enter a valid ConvertKit API Key on the ConvertKit Integration Settings page.' ); ?>
</p>
<?php } ?>
