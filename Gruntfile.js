module.exports = function(grunt) {
    grunt.initConfig({
        ...
        checktextdomain: {
            options:{
                text_domain: 'convertkit-woocommerce',
                keywords: [
                    '__:1,2d',
                    '_e:1,2d',
                    '_x:1,2c,3d',
        ...
        makepot: {
            options: {
                ...
                mainFile: 'woocommerce-convertkit.php',
                potHeaders: {
                    poedit: true,
                    'report-msgid-bugs-to': 'https://github.com/ConvertKit/woocommerce-convertkit/issues',
            ...
            frontend: {
                options: {
                    potFilename: 'convertkit-woocommerce.pot',
                    exclude: [
                        'bin',
                        'tests/.*',
                        'node_modules',
